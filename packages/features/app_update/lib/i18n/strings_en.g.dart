...
class TranslationsAppUpdateEn {
	...
	// Translations
	late final TranslationsAppUpdateAppUpdatePageEn appUpdatePage = TranslationsAppUpdateAppUpdatePageEn.internal(_root);
}

// Path: appUpdate.appUpdatePage
class TranslationsAppUpdateAppUpdatePageEn {
	TranslationsAppUpdateAppUpdatePageEn.internal(this._root);
