...
class TranslationsMaintenanceEn {
	...
	// Translations
	late final TranslationsMaintenanceMaintenancePageEn maintenancePage = TranslationsMaintenanceMaintenancePageEn.internal(_root);
}

// Path: maintenance.maintenancePage
class TranslationsMaintenanceMaintenancePageEn {
	TranslationsMaintenanceMaintenancePageEn.internal(this._root);
