...
class TranslationsJa extends Translations {
	...
	// Translations
	@override late final _TranslationsCoreJa core = _TranslationsCoreJa._(_root);
}

// Path: core
class _TranslationsCoreJa extends TranslationsCoreEn {
	_TranslationsCoreJa._(TranslationsJa root) : this._root = root, super.internal(root);
